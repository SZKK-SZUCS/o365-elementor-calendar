...
class SingleEventWidget extends AbstractWidget {
    ...
    protected function register_controls() {
        ...
        $this->add_control('text_details', ['label' => 'Részletek gomb', 'type' => Controls_Manager::TEXT, 'default' => 'Részletek']);
        $this->add_control('text_join', ['label' => 'Online Meeting gomb', 'type' => Controls_Manager::TEXT, 'default' => 'Csatlakozás']);
        $this->add_control('text_link', ['label' => 'Link megnyitása gomb', 'type' => Controls_Manager::TEXT, 'default' => 'Megnyitás']);
        $this->end_controls_section();
        ...
        $this->add_control('card_radius', ['label' => 'Lekerekítés', 'type' => Controls_Manager::SLIDER, 'selectors' => ['{{WRAPPER}} .o365-single-card' => 'border-radius: {{SIZE}}{{UNIT}};']]);
        $this->add_responsive_control('card_padding', ['label' => 'Belső Margó (Felső Sáv)', 'type' => Controls_Manager::DIMENSIONS, 'selectors' => ['{{WRAPPER}} .single-event-main' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};']]);
        ...
        $this->add_control('badge_radius', ['label' => 'Lekerekítés', 'type' => Controls_Manager::SLIDER, 'selectors' => ['{{WRAPPER}} .single-event-date-badge' => 'border-radius: {{SIZE}}{{UNIT}};']]);
        ...
        $this->add_control('cd_radius', ['label' => 'Lekerekítés', 'type' => Controls_Manager::SLIDER, 'selectors' => ['{{WRAPPER}} .single-event-countdown' => 'border-radius: {{SIZE}}{{UNIT}};']]);
        ...
        $this->add_responsive_control('panel_padding', ['label' => 'Belső Margó (Padding)', 'type' => Controls_Manager::DIMENSIONS, 'selectors' => ['{{WRAPPER}} .single-event-panel-inner' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};']]);
        ...
        // 2.6 Gombok (Mentés, Részletek, Meeting)
        $this->start_controls_section('style_buttons', ['label' => __( 'Akció Gombok', 'o365-elementor-calendar' ), 'tab' => Controls_Manager::TAB_STYLE]);
        $this->add_control('btn_radius', ['label' => 'Lekerekítés', 'type' => Controls_Manager::SLIDER, 'selectors' => ['{{WRAPPER}} .o365-single-toggle-btn, {{WRAPPER}} .o365-single-export, {{WRAPPER}} .o365-meeting-btn' => 'border-radius: {{SIZE}}{{UNIT}};']]);
        ...
        $this->add_control('meet_bg', ['label' => 'Meeting Gomb Háttér', 'type' => Controls_Manager::COLOR, 'separator' => 'before', 'selectors' => ['{{WRAPPER}} .o365-meeting-btn' => 'background-color: {{VALUE}}; border-color: {{VALUE}};']]);
        $this->add_control('meet_color', ['label' => 'Meeting Gomb Szöveg', 'type' => Controls_Manager::COLOR, 'selectors' => ['{{WRAPPER}} .o365-meeting-btn' => 'color: {{VALUE}};']]);
        $this->end_controls_tab();
        // Hover
        $this->start_controls_tab('tab_sbtn_hover', ['label' => 'Hover / Aktív']);
        ...
        $this->add_control('meet_h_bg', ['label' => 'Meeting Gomb Háttér', 'type' => Controls_Manager::COLOR, 'separator' => 'before', 'selectors' => ['{{WRAPPER}} .o365-meeting-btn:hover' => 'background-color: {{VALUE}}; border-color: {{VALUE}};']]);
        $this->add_control('meet_h_color', ['label' => 'Meeting Gomb Szöveg', 'type' => Controls_Manager::COLOR, 'selectors' => ['{{WRAPPER}} .o365-meeting-btn:hover' => 'color: {{VALUE}};']]);
        $this->end_controls_tab();
    ...
    protected function render() {
        ...
        // Minden adatot átadunk a JS-nek
        ?>
