...
class CalendarWidget extends AbstractWidget {
    ...
    protected function register_controls() {
        ...
        $this->add_control('display_event_time', [
            'label'   => __( 'Időpont mutatása', 'o365-elementor-calendar' ),
        ...
        $this->add_control('privacy_mode', [
            'label'   => __( 'Privát események', 'o365-elementor-calendar' ),
            'type'    => Controls_Manager::SELECT,
            'default' => 'mask',
            'options' => [
        ...
        $this->add_control('empty_state_text', [
            'label'   => 'Üres állapot szövege',
            'type'    => Controls_Manager::TEXTAREA,
            'default' => 'Nincs megjeleníthető esemény ebben az időszakban.',
            'rows'    => 3,
        ]);
        ...
        $this->add_control('privacy_mask_text', [
            'label'     => 'Maszkolt esemény (Foglalt)', 
        ...
        $this->add_control('header_text_color', ['label' => 'Napok neve színe', 'type' => Controls_Manager::COLOR, 'selectors' => [ '{{WRAPPER}} .fc-col-header-cell-cushion' => 'color: {{VALUE}} !important;' ]]);
    ...
    protected function render() {
        ...
        <div class="o365-fullcalendar-container" 
             ...
             data-views-tablet="<?php echo esc_attr( implode(',', (array)$settings['views_tablet']) ); ?>"
             data-default-tablet="<?php echo esc_attr($settings['default_tablet']); ?>"
             
             data-views-mobile="<?php echo esc_attr( implode(',', (array)$settings['views_mobile']) ); ?>"
             data-default-mobile="<?php echo esc_attr($settings['default_mobile']); ?>"
             ...
             data-use-colors="<?php echo esc_attr($settings['use_o365_colors']); ?>"
             data-display-event-time="<?php echo esc_attr($settings['display_event_time']); ?>"
             data-locale="<?php echo esc_attr($locale); ?>"
             
             data-text-empty="<?php echo esc_attr($settings['empty_state_text']); ?>"
